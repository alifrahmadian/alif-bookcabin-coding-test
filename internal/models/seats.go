...
type Seat struct {
	...
	EntitledRuleID         sql.NullInt64  `json:"entitled_rule_id"`
	FeeWaiveRuleID         sql.NullInt64  `json:"fee_waive_rule_id"`
	...
	PriceAmount            sql.NullInt64  `json:"price_amount"`
	PriceCurrency          sql.NullString `json:"price_currency"`
	TaxAmount              sql.NullInt64  `json:"tax_amount"`
	TaxCurrency            sql.NullString `json:"tax_currency"`
	TotalAmount            sql.NullInt64  `json:"total_amount"`
	TotalCurrency          sql.NullString `json:"total_currency"`
}
